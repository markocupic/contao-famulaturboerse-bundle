...
$GLOBALS['TL_DCA']['tl_famulatur_angebot'] = array(
    ...
    'fields'   => array(
        ...
        'anform_richtung'         => array(
            ...
            'exclude'   => true,
            'inputType' => 'select',
            //'options'   => array('Allgemeinmediziner/Hausarzt', 'Hausärztlich tätiger Internist', 'Kinder- und Jugendarzt', 'Allgemeinmediziner / Hausarzt'),
            'options'   => array('Hausärztlich tätiger Internist', 'Kinder- und Jugendarzt', 'Allgemeinmediziner / Hausarzt'),
            'filter'    => true,
            'sorting'   => true,
            'search'    => false,
